    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#a3a3a3] text-sm mt-2">Redirecting to sign in...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#525252] text-sm mt-2">Create your account</p>
        </div>
        ...
        <div className="bg-[#111111] border border-[#1f1f1f] rounded-lg p-8 space-y-5">
          ...
          <div className="space-y-1">
            <label className="text-[#a3a3a3] text-xs uppercase tracking-wider">Confirm password</label>
            <input
              type="password"
              value={confirm}
